...
function patListTest(lp, n){
    //print("plt n:"+n + " isArray:"+Array.isArray(n));
	//if(n && !Array.isArray(n)) print("plt not array:"+Object.keys(n)+" "); 
	//print("plt "+lp.length + " " + n.length);
	
	return Array.isArray(n)
	&& n.length == lp.length
	&& lp.reduce(function(z, p) z && p(n), true); // era false por error
};
